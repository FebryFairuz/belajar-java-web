package com.febry.belajar.javaweb.produk;
...
public class ProdukController {
    ...
    @RequestMapping("/belajar/produk/daftar-produk")
    ...
    @RequestMapping(value = "/belajar/produk/input-produk", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/belajar/produk/input-produk", method = RequestMethod.POST)
    public String prosesProduk(@ModelAttribute @Valid Produk p, BindingResult hasilValidasi, SessionStatus status) throws Exception{
        ...
        if(hasilValidasi.hasErrors()){
            return "/belajar/produk/input-produk";
        }
    ...
    @RequestMapping("/belajar/produk/hapus")
